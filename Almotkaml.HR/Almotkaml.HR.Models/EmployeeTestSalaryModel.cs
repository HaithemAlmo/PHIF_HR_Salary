...
{
    public class EmployeeTestSalaryModel
    {
    
    //public class EntrantsAndReviewersIndexModel
    //{
        public IEnumerable<EmployeeTestSalaryGridRow> EmployeeTestSalayGridRow { get; set; } = new HashSet<EmployeeTestSalaryGridRow>();
       ...
       // [Required(ErrorMessageResourceType = typeof(SharedMessages), ErrorMessageResourceName = nameof(SharedMessages.IsRequired))]
        ...
        [Date]
        [Display(ResourceType = typeof(Title),
           Name = nameof(Title.DateStartJob))]
    ...
    public class EmployeeTestSalaryGridRow
    {
        public int EmployeeTestSalaryId { get;  set; }
        public string EmployeeTestName { get; set; }
        //public string FirstName { get; set; }
        //public string FatherName { get;  set; }
        //public string GrandfatherName { get; set; }
    ...
    public class EmployeeTestSalaryListItem
    {
        public string EmployeeTestName { get; set; }
        public int EmployeeTestSalaryId { get;  set; }
        public string FirstName { get;  set; }
