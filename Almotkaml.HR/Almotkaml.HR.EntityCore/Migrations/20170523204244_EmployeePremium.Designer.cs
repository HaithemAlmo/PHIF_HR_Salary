...
namespace Almotkaml.HR.EntityCore.Migrations
{
    ...
    [Migration("20170523204244_EmployeePremium")]
    partial class EmployeePremium
    {
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Activity", b =>
                {
                    ...
                    b.Property<int?>("SalaryPremiumPremiumId");

                    b.Property<long?>("SalaryPremiumSalaryId");
                    ...
                    b.HasIndex("SalaryPremiumPremiumId", "SalaryPremiumSalaryId");
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Salary", b =>
                {
                    ...
                    b.Property<decimal>("AdvancePremium");

                    b.Property<int>("BankBranchId");

                    b.Property<decimal>("BasicSalary");

                    b.Property<string>("BoundNumber")
                        .IsRequired()
                        .HasMaxLength(128);
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Activity", b =>
                {
                    ...
                    b.HasOne("Almotkaml.HR.Domain.Premium")
                        .WithMany("Activities")
                    ...
                    b.HasOne("Almotkaml.HR.Domain.Salary")
                        .WithMany("Activities")
                    ...
                    b.HasOne("Almotkaml.HR.Domain.SalaryPremium")
                        .WithMany("Activities")
                        .HasForeignKey("SalaryPremiumPremiumId", "SalaryPremiumSalaryId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
