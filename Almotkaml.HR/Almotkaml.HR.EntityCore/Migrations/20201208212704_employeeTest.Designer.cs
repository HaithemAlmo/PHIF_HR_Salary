...
namespace Almotkaml.HR.EntityCore.Migrations
{
    ...
    [Migration("20201208212704_employeeTest")]
    partial class employeeTest
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.EmployeeTest", b =>
                {
                    b.Property<int>("EmployeeTestId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("DateEndJob");
                    ...
                    b.HasKey("EmployeeTestId");

                    b.ToTable("EmployeeTest");
                });

            modelBuilder.Entity("Almotkaml.HR.Domain.EmployeeTestSalary", b =>
                {
                    b.Property<int>("EmployeeTestSalaryID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("EmployeeTestSalaryID");

                    b.ToTable("EmployeeTestSalary");
                });
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.EntrantsAndReviewers", b =>
                {
                    ...
                    b.HasKey("EntrantsAndReviewersId");

                    b.ToTable("EntrantsAndReviewerss");
                });
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Premium", b =>
                {
                    ...
                    b.Property<int>("ISAdvanceInside");

                    b.Property<int>("ISAdvancePremmium");

                    b.Property<int>("IsFrozen");

                    b.Property<int>("IsSubject");
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Salary", b =>
                {
                    ...
                    b.Property<decimal>("TotalSalaryTest");
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.SalaryUnit", b =>
                {
                    ...
                    b.Property<decimal>("ExtraValue1");

                    b.Property<decimal>("ExtraValue10");

                    b.Property<decimal>("ExtraValue11");

                    b.Property<decimal>("ExtraValue12");

                    b.Property<decimal>("ExtraValue2");

                    b.Property<decimal>("ExtraValue3");

                    b.Property<decimal>("ExtraValue4");

                    b.Property<decimal>("ExtraValue5");

                    b.Property<decimal>("ExtraValue6");

                    b.Property<decimal>("ExtraValue7");

                    b.Property<decimal>("ExtraValue8");

                    b.Property<decimal>("ExtraValue9");

                    b.Property<decimal>("HIF1");

                    b.Property<decimal>("HIF10");

                    b.Property<decimal>("HIF11");

                    b.Property<decimal>("HIF12");

                    b.Property<decimal>("HIF2");

                    b.Property<decimal>("HIF3");

                    b.Property<decimal>("HIF4");

                    b.Property<decimal>("HIF5");

                    b.Property<decimal>("HIF6");

                    b.Property<decimal>("HIF7");

                    b.Property<decimal>("HIF8");

                    b.Property<decimal>("HIF9");
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.TechnicalAffairsDepartment", b =>
                {
                    ...
                    b.Property<decimal>("AccommodationReviewBalance");

                    b.Property<int>("AccommodationReviewCount");

                    b.Property<decimal>("ClincReviewBalance");

                    b.Property<int>("ClincReviewCount");

                    b.Property<decimal>("DataEntryBalance");

                    b.Property<int>("DataEntryCount");

                    b.Property<int>("EntrantsAndReviewersId");

                    b.Property<decimal>("FirstReviewBalance");
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.EmployeePremium", b =>
                {
                    b.HasOne("Almotkaml.HR.Domain.AdvancePayment", "AdvancePayment")
                        .WithMany()
            ...
            modelBuilder.Entity("Almotkaml.HR.Domain.Salary", b =>
                {
                    ...
                    b.HasOne("Almotkaml.HR.Domain.SalaryInfo", "SalaryInfo")
                        .WithMany()
