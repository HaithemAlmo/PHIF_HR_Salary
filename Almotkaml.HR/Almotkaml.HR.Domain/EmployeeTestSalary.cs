...
namespace Almotkaml.HR.Domain
{
    public class EmployeeTestSalary
    {
        ...
        //    Employee = employee;
        //}
        //  public EmployeeTestSalary(string firstName, string fatherName,string grandfatherName, string lastName
        //      , DateTime dateStartJob, DateTime dateEndJob, string nationalNumber, string nationality
        //      , string address, string phone,string email, Gender gender, DateTime monthDate,string department , bool stateEmployee)
        //  {
        //      FirstName = FirstName;
        ...
        //  }
        public static EmployeeTestSalary New(string firstName, string fatherName, string grandfatherName, string lastName
           , DateTime dateStartJob, DateTime dateEndJob, string nationalNumber, string nationality
           , string address, string phone, string email, Gender gender, string department, bool stateEmployee)
        {
            var employeeTest = new EmployeeTestSalary();
           ...
           // employeeTest.MonthDate = monthDate;
        ...
        public int EmployeeTestSalaryID { get; internal set; }
