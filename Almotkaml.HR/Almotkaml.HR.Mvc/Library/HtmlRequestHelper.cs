...
namespace Almotkaml.HR.Mvc.Library
{
    public static class HtmlRequestHelper
    {
        ...
        public static ISettings GetSettings(this HtmlHelper htmlHelper)
            => htmlHelper.ViewBag.SettingsModel as ISettings;

        public static Permission GetPermissions(this HtmlHelper htmlHelper)
            => (htmlHelper.ViewBag.ProfileModel as IApplicationUser)?.Permissions;

        public static IApplicationUser GetApplicationUser(this HtmlHelper htmlHelper)
            => htmlHelper.ViewBag.ProfileModel as IApplicationUser;
