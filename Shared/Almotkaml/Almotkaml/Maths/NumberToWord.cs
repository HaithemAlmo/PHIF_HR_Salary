...
namespace Almotkaml.Maths
{
    public class NumberToWord
    {
        ...
        {
            number = decimal.Parse(number.ToString("0.000"));
            InitializeClass(number, new CurrencyInfo(CurrencyInfo.Currencies.Libya), string.Empty, "only.", "فقط", " لا غير.");
        }
        ...
        public class CurrencyInfo
        {
            ...
            {
                Syria = 0, Uae, SaudiArabia, Tunisia, Gold,
                Libya
            };
